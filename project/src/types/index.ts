 ...
 * Source: docs/02-data-model.ts
 * Note: Utilisation de const objects au lieu d'enums pour compatibilité erasableSyntaxOnly
 */

// =============================================================================
// CONST OBJECTS (remplacent les enums pour compatibilité TypeScript strict)
// =============================================================================
...
export type StatutFormation =
  (typeof StatutFormation)[keyof typeof StatutFormation];
...
export const NiveauPersonnalisation = {
  STANDARD: "standard",
  SPECIFIQUE: "spécifique",
  ULTRA_SPECIFIQUE: "ultra-spécifique"
} as const;
export type NiveauPersonnalisation =
  (typeof NiveauPersonnalisation)[keyof typeof NiveauPersonnalisation];
...
export type TypeEmail = (typeof TypeEmail)[keyof typeof TypeEmail];

/** Entité de facturation */
export const EntiteFacturation = {
  ORSYS: "ORSYS",
...
export type EntiteFacturation =
  (typeof EntiteFacturation)[keyof typeof EntiteFacturation];
...
export interface AppSettings {
  ...
  /** Délai entre les appels LLM en ms (pour éviter les rate limits) */
  llmDelayMs?: number;
