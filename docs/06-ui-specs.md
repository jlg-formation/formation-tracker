...
Objectif : consulter les **emails** et leur **analyse** associée.

Exigences :

- À l’arrivée sur cette page, afficher la **liste de tous les emails**.
- La liste doit être **paginée** (environ **7 000** emails).
- Pour chaque email, permettre de **cliquer pour accéder à sa page détail**.

---

## Page détail : Mail

Cette page est accessible en cliquant sur un email depuis la page **Mails**.
...
│  │  • Participants : 5                                                    │   │
│  │                                                                        │   │
│  │  🔗 Formation associée : [Voir la formation →]                        │   │
│  └──────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│  ┌──────────────────────────────────────────────────────────────────────┐   │
│  │  📨 Email brut                                              [▼ Ouvrir] │   │
...
│  │  Quand ouvert :                                                        │   │
│  │  ┌────────────────────────────────────────────────────────────────┐   │   │
│  │  │ De : formations@orsys.fr                                        │   │   │
│  │  │ Date : 08/02/2026 10:30                                         │   │   │
│  │  │ Sujet : Confirmation animation inter                            │   │   │
│  │  │ ──────────────────────────────────                               │   │   │
│  │  │ Bonjour,                                                         │   │   │
│  │  │                                                                   │   │   │
│  │  │ Veuillez trouver ci-dessous les informations...                 │   │   │
│  │  │ ...                                                               │   │   │
│  │  └────────────────────────────────────────────────────────────────┘   │   │
│  └──────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
...
│  │                                                                        │  │
│  │  ───────────────────────────────────────────────────────────────────   │  │
│  │  Modèle OpenAI : [▼ GPT-5 Nano (~0.10$/1M) ]                          │  │
│  │                  ├─ GPT-5 Nano (~0.10$/1M) - défaut                    │  │
│  │                  ├─ GPT-5 Mini (~0.20$/1M)                             │  │
...
- **Bouton** : "corriger adresse des formation virtuel"
- **Règle** : une formation est dite virtuelle lorsque `codeEtendu` se termine par `CV<n>` où `<n>` est un chiffre (`0`…`9`).
- **Effet** : met à jour l'adresse du lieu de ces formations à : `2 allée du Commandant Charcot 77200 TORCY (France)`
- **Objectif** : permettre de corriger ce cas sans relancer une analyse LLM coûteuse.
